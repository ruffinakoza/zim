/*
 * $Id: interp.c 1019 2007-02-15 00:52:41Z zsuzsu $
 */
...
cmd_t cmd_table[] =
{
    ...
    { "commune",        do_commune,     POS_FIGHTING,    0,  LOG_NORMAL, CMD_NOORDER }, 
    { "channel",	do_channel,	POS_FIGHTING,	 0,  LOG_NORMAL, CMD_NOORDER },
    { "auction",        do_auction,     POS_SLEEPING,    0,  LOG_NORMAL	},
    { "buy",		do_buy,		POS_RESTING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK	},
    { "channels",       do_channels,    POS_DEAD,        0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "dual",		do_second_wield,POS_RESTING,	 0,  LOG_NORMAL },
    { "enter", 		do_enter, 	POS_STANDING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK	},
    { "exits",		do_exits,	POS_RESTING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    { "estimate",	do_estimate,	POS_RESTING,	 0,  LOG_NORMAL },
    { "get",		do_get,		POS_RESTING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_ORDERPC_OK },
    { "go",		do_enter,	POS_STANDING,	 0,  LOG_NORMAL, CMD_HIDDEN | CMD_ORDERPC_OK },
    ...
    { "rest",		do_rest,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_ORDERPC_OK },
    { "repair",		do_repair,	POS_SLEEPING,	 0,  LOG_NORMAL },
    { "label",		do_label,	POS_RESTING,	 0,  LOG_NORMAL, CMD_NOORDER},
    { "second",		do_second_wield,POS_RESTING,	 0,  LOG_NORMAL	},
    { "sit",		do_sit,		POS_SLEEPING,    0,  LOG_NORMAL, CMD_ORDERPC_OK},
    { "smithing",	do_smithing,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "stand",		do_stand,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    { "tell",		do_tell,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "unlock",         do_unlock,      POS_RESTING,     0,  LOG_NORMAL, CMD_ORDERPC_OK	},
    { "wield",		do_wear,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "donate",         do_donate,      POS_STANDING,        0,  LOG_NORMAL }, 
    { "cdonate", 	do_cdonate,	POS_STANDING,        0,  LOG_NORMAL },
    { "language",	do_lang,	POS_DEAD,	0,   LOG_NORMAL	},
    { "write",          do_write,       POS_RESTING,     0,  LOG_NORMAL },
    ...
    { "crime",		do_crime,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    ...
    { "consecrate",	do_consecrate,	POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE	},
    { "count",		do_count,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    ...
    { "events",		do_events,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    ...
    { "read",		do_look,	POS_RESTING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    ...
    { "speak",		do_speak,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    ...
    { "waff",		do_waff,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    ...
    { "clan",		do_clan,	POS_SLEEPING,    0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "=",		do_clan,	POS_SLEEPING,    0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "clanlist",	do_clanlist,	POS_SLEEPING,    0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "clantitles",	do_clantitles,	POS_SLEEPING,    0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "clanrecall",	do_crecall,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "deaf",		do_deaf,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "emote",		do_emote,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "pmote",		do_pmote,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { ",",		do_emote,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "gtell",		do_gtell,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { ";",		do_gtell,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "notes",		do_note,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "petitio",	do_petitio,	POS_DEAD,	 0,  LOG_ALWAYS },
    { "petition",	do_petition,	POS_DEAD,	 0,  LOG_ALWAYS, CMD_NOORDER },
    { "pose",		do_pose,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "promote",	do_promote,	POS_DEAD,	 0,  LOG_ALWAYS, CMD_KEEP_HIDE | CMD_NOORDER	},
    { "pray",           do_pray,        POS_DEAD,        0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "wizhelp",	do_wizhelp,	POS_DEAD,        0,  LOG_ALWAYS, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_FROZEN_OK },
    { "immhelp",	do_wizhelp,	POS_DEAD,        0,  LOG_ALWAYS, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_FROZEN_OK },
    { "helpimm",	do_wizhelp,	POS_DEAD,        0,  LOG_ALWAYS, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_FROZEN_OK },
    { "reply",		do_reply,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "replyimm",	do_replyimm,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_FROZEN_OK | CMD_NOORDER },
    { ".",		do_reply,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "replay",		do_replay,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_CHARMED_OK },
    { "noreply",	do_noreply,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "whisper",        do_whisper,     POS_RESTING,     0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK },
    { "\\",		do_whisper,     POS_RESTING,     0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "say",		do_say,		POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "'",		do_say,		POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "shout",		do_shout,	POS_RESTING,	91,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "offer",		do_offer,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "music",		do_music,	POS_RESTING,	IM,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "gossip", 	do_gossip,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "ooc",            do_ooc,         POS_DEAD,        0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "newbie",		do_newbie,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "motd",		do_motd,	POS_DEAD,        0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "wake",		do_wake,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    { "warcry",         do_warcry,      POS_FIGHTING,    0,  LOG_NORMAL	},
    { "unread",		do_unread,	POS_SLEEPING,    0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK },
    { "yell",		do_yell,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK| CMD_ORDERPC_OK },
    ...
    { "autoenslave",	do_autoenslave,	POS_DEAD,        0,  LOG_NORMAL, CMD_KEEP_HIDE },
    ...
    { "delve",		do_delve,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK},
    ...
    { "enslave",        do_enslave,     POS_RESTING,     0,  LOG_ALWAYS, CMD_KEEP_HIDE | CMD_NOORDER },
   ...
   /* #{ "title",		do_title,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_NOORDER },*/
     ...
     */
    { "artifacts",	do_artifacts,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE	},
    { "bestow",		do_bestow_award,POS_STANDING,	 0,  LOG_ALWAYS	},
    ...
    { "kudos",		do_kudos,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE	},
    ...
    { "sleep",		do_sleep,	POS_SLEEPING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    ...
    { "wager",		do_wager,	POS_RESTING,	 0,  LOG_NORMAL },
    ...
    { "repudiate",	do_repudiate,	POS_DEAD,	 0,  LOG_NORMAL },
    ...
    { "chumpchange",	do_chumpchange,	POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    ...
    { "drink",		do_drink,	POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    { "drop",		do_drop,	POS_RESTING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    { "eat",		do_eat,		POS_RESTING,	 0,  LOG_NORMAL, CMD_CHARMED_OK | CMD_ORDERPC_OK},
    ...
    { "give",		do_give,	POS_RESTING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    ...
    { "medals",		do_medals,	POS_RESTING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    { "meldstone",	do_meld_into_stone,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "open",		do_open,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "peek", 		do_peek_inside, POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    { "pick",		do_pick,	POS_STANDING,	 0,  LOG_NORMAL, CMD_ORDERPC_OK},
    { "pickpocket",	do_pickpocket,	POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_ORDERPC_OK},
    { "pin", 		do_pin_medal, 	POS_STANDING,	 0,  LOG_ALWAYS	},
    { "plant", 		do_plant,	POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE },
    ...
    { "scalp",		do_scalp,	POS_STANDING,	 0,  LOG_ALWAYS, },
    { "scratch",	do_scratch,	POS_RESTING,	 0,  LOG_NORMAL	},
    ...
    { "unbestow",	do_unbestow_award,POS_STANDING,	 0,  LOG_ALWAYS	},
    { "unpin", 		do_unpin_medal,	POS_STANDING,	 0,  LOG_ALWAYS	},
    ...
    { "bashdoor",	do_bash_door,	POS_FIGHTING,    0,  LOG_NORMAL, CMD_ORDERPC_OK},
    ...
    { "sling",          do_sling,       POS_FIGHTING,    0,  LOG_NORMAL },
    ...
    { "lash",           do_lash,        POS_FIGHTING,    0,  LOG_NORMAL },
    ...
    { "shuriken",       do_shuriken,    POS_FIGHTING,    0,  LOG_NORMAL },
    ...
    { "wild swing",     do_wild_swing,  POS_STANDING,    0,  LOG_NORMAL },
    ...
    { "dismantle",      do_dismantle,   POS_STANDING,    0,  LOG_NORMAL },
    ...
    { "bush",           do_bush_sense,  POS_RESTING,     0,  LOG_NORMAL	},
    { "pure",		do_pure,	POS_RESTING,	 0,  LOG_NORMAL },
    { "clairvoyance",   do_clairvoyance, POS_RESTING,     0,  LOG_NORMAL	},
     ...
     */
    /* level 92 */
    { "affrooms",	do_affrooms,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "force",		do_force,	POS_DEAD,	IM,  LOG_ALWAYS	},
    { "goto",           do_goto,        POS_DEAD,       IM,  LOG_NORMAL },
    { "herotitle",	do_herotitle,	POS_DEAD,	IM,  LOG_ALWAYS	},
    ...
    { "inform",		do_inform,	POS_DEAD,	IM,  LOG_ALWAYS	},
    { "invis",		do_invis,	POS_DEAD,	IM,  LOG_NORMAL	},
 /* { "ititle",		do_ititle,	POS_DEAD,	IM,  LOG_NORMAL },*/
    { "mpstat",		do_mpstat,	POS_DEAD,	IM,  LOG_NEVER	},
    { "noaffect",	do_noaffect,	POS_DEAD,	IM,  LOG_ALWAYS	},
    { "peace",		do_peace,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "penalty",	do_penalty,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "penalties",	do_penalty,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "poofin",		do_bamfin,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "poofout",	do_bamfout,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "questtalk",	do_questtalk,	POS_DEAD, 	IM,  LOG_NORMAL	},
    { "qt",		do_questtalk,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "rename",		do_rename,	POS_DEAD,	IM,  LOG_ALWAYS	},
    { "smote",		do_smote,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "teleport",	do_transfer,    POS_DEAD,	IM,  LOG_ALWAYS	},	
    { "transfer",	do_transfer,	POS_DEAD,	IM,  LOG_ALWAYS	},
    { "wizcom",		do_wizcmd,	POS_DEAD,	IM,  LOG_NORMAL, CMD_HIDDEN },
    { "wizinvis",	do_invis,	POS_DEAD,	IM,  LOG_NORMAL	},
    { "wiznet",		do_wiznet,	POS_DEAD,	IM,  LOG_NORMAL	},

    /* level 93 */
/*  { "check",          do_check,       POS_DEAD,       L7,  LOG_ALWAYS },*/
    { "clone",		do_clone,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "dmtalk",		do_dmtalk,	POS_DEAD,	L7,  LOG_ALWAYS, CMD_HIDDEN},
    { "load",		do_load,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "mwhere",		do_mwhere,	POS_DEAD,	L7,  LOG_NORMAL	},
    { "pecho",		do_pecho,	POS_DEAD,	L7,  LOG_ALWAYS	}, 
    { "purge",		do_purge,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "osockets",       do_osockets,    POS_DEAD,       L7,  LOG_ALWAYS },
    { "scatter",        do_scatter,     POS_DEAD,       L7,  LOG_ALWAYS }, 
    { "silence",	do_silence,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "sockets",        do_sockets,     POS_DEAD,       L7,  LOG_ALWAYS }, 
    { "stat",		do_stat,	POS_DEAD,	L7,  LOG_NORMAL	},
    /*
     * OLC
     */
    { "alist",		do_alist,	POS_DEAD,	L7,  LOG_NORMAL },
    { "asave",          do_asave,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "ashow",		do_ashow,	POS_DEAD,	L7,  LOG_NORMAL	},
    { "create",		do_create,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "edit",		do_edit,	POS_DEAD,	L7,  LOG_ALWAYS	},
    { "resets",		do_resets,	POS_DEAD,	L7,  LOG_NORMAL	},

    /* level 94 */
    { "at",             do_at,          POS_DEAD,       L6,  LOG_ALWAYS },     
    { "echo",		do_recho,	POS_DEAD,	L6,  LOG_ALWAYS	},
    { "owhere",		do_owhere,	POS_DEAD,	L6,  LOG_NORMAL	},
    { "prefi",		do_prefi,	POS_DEAD,	L6,  LOG_NORMAL, CMD_HIDDEN },
    { "prefix",		do_prefix,	POS_DEAD,	L6,  LOG_NORMAL	},
    { "smite",		do_smite,	POS_DEAD,	L6,  LOG_ALWAYS	},
    { "switch",		do_switch,	POS_DEAD,	L6,  LOG_ALWAYS	},
    { "warena",		do_warena,	POS_DEAD, 	L6,  LOG_ALWAYS	},

    /* level 95 */
    { "addlag",         do_addlag,      POS_DEAD,       L5,  LOG_ALWAYS },
    { "anoncolor",	do_anoncolor,   POS_DEAD,       L5,  LOG_ALWAYS },     
    { "award",          do_award,       POS_DEAD,       L5,  LOG_ALWAYS },
    { "noexp",          do_noexp,       POS_DEAD,       L5,  LOG_ALWAYS },  
    { "notitle",	do_notitle,	POS_DEAD,	L5,  LOG_ALWAYS	},
    { "string",		do_string,	POS_DEAD,	L5,  LOG_ALWAYS	},
    { "version",	do_version,	POS_DEAD,	L5,  LOG_NORMAL, CMD_HIDDEN },
    ...
    /* level 97 */
    { "freeze",		do_freeze,	POS_DEAD,	L3,  LOG_ALWAYS	},
    { "set",		do_set,		POS_DEAD,	L3,  LOG_ALWAYS	},

    /* level 98 */
    { "disconnect",	do_disconnect,	POS_DEAD,	L2,  LOG_ALWAYS	},
    { "memory",		do_memory,	POS_DEAD,	L2,  LOG_NEVER	},
    { "msgstat",	do_msgstat,	POS_DEAD,	L2,  LOG_NEVER	},
    { "ofind",		do_ofind,	POS_DEAD,	L2,  LOG_ALWAYS	},
    { "popularity",	do_popularity,	POS_DEAD,	L2,  LOG_ALWAYS	},
    { "strstat",	do_strstat,	POS_DEAD,	L2,  LOG_NEVER	},

    /* level 99 */
    { "aschar",		do_aschar,	POS_DEAD,	L1,  LOG_ALWAYS },
    { "ban",		do_ban,		POS_DEAD,	L1,  LOG_ALWAYS	},
    { "matchup",	do_matchup,	POS_DEAD,	L1,  LOG_ALWAYS	},
    { "newlock",	do_newlock,	POS_DEAD,	L1,  LOG_ALWAYS	},
    { "protect",	do_protect,	POS_DEAD,	L1,  LOG_ALWAYS	},
    { "reclaim",	do_reclaim,	POS_DEAD,	L1,  LOG_ALWAYS	}, 
    { "restore",	do_restore,	POS_DEAD,	L1,  LOG_ALWAYS	},
    { "sla",		do_sla,		POS_DEAD,	L1,  LOG_ALWAYS	},
    { "slay",		do_slay,	POS_DEAD,	L1,  LOG_ALWAYS	},

    /* level 100 */
    { "advance",	do_advance,	POS_DEAD,	ML,  LOG_ALWAYS	}, 
    { "allow",		do_allow,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "debug",		do_debug,	POS_DEAD,	ML,  LOG_ALWAYS	}, 
    { "disable",	do_disable,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "dump",		do_dump,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "deny",		do_deny,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "enable",		do_enable,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "find",		do_find,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "gconfig",	do_gconfig,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "gsave",		do_save_world_config,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "gload",		do_load_world_config,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "grant",		do_grant,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "log",		do_log,		POS_DEAD,	ML,  LOG_ALWAYS	},
    { "maxon",		do_maxon,	POS_DEAD,       ML,  LOG_NORMAL, CMD_HIDDEN },
    { "objlist",	do_objlist,	POS_DEAD,	ML,  LOG_NORMAL	},
    { "pdata",		do_pdata,	POS_DEAD,	ML,  LOG_NORMAL	},
    { "permban",	do_permban,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "pload",		do_pload,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "punload",	do_punload,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "reboo",		do_reboo,	POS_DEAD,	ML,  LOG_NEVER, CMD_HIDDEN	},
    { "reboot",		do_reboot,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "repossess",	do_repossess,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "shutdow",	do_shutdow,	POS_DEAD,	ML,  LOG_ALWAYS, CMD_HIDDEN	},
    { "shutdown",	do_shutdown,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "snoop",		do_snoop,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "usage",		do_usage,	POS_DEAD,	ML,  LOG_NORMAL },
    { "violate",	do_violate,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "wgstat",		do_wgstat,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "wizlock",	do_wizlock,	POS_DEAD,	ML,  LOG_ALWAYS	},
    { "wpeace",         do_wpeace,      POS_DEAD,       ML,  LOG_ALWAYS },
    { "wset",		do_wset,	POS_DEAD,       ML,  LOG_ALWAYS },
    { "wsave",		do_save_waffs,	POS_DEAD,	ML,  LOG_ALWAYS },
    { "_zzoneshot",	do_zzoneshot,	POS_DEAD,	ML,  LOG_ALWAYS, CMD_HIDDEN },


    /* mortal skills that have longer names than IMM commands */
    { "bandage",        do_bandage,     POS_FIGHTING,    0,  LOG_NORMAL	},
    { "settraps",	do_settraps,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "switcheroo",	do_switcheroo,	POS_STANDING,	 0,  LOG_NORMAL, CMD_KEEP_HIDE	},
    /*
     * End of list.
     */
     { NULL }
...
{
	interpret_raw(ch, argument, FALSE, 0);
}
...
int interpret_raw(CHAR_DATA *ch, const char *argument, bool is_order, int force_level)
{
	...
	for (cmd = cmd_table; cmd->name; cmd++) {
		 ...
		 */
		if (!IS_NPC(ch)
		&&  IS_SET(ch->state_flags, STATE_FREEZE)
		...
		if (is_order) {
			...
			if (!IS_NPC(ch)
			&& force_level < LEVEL_IMMORTAL 
			&& !IS_SET(cmd->flags, CMD_ORDERPC_OK))
				return FALSE;
		}
		else {
	...
	if (((!IS_NPC(ch) && IS_SET(ch->state_flags, STATE_LOG))
	||   fLogAll
	...
	if (!found) {
		...
		if (!IS_NPC(ch) 
		&& IS_SET(ch->restricted_channels, CHAN_GLOBAL_EMOTE)) {
		...
		switch(ch->position) {
			...
			case POS_SITTING:
				if(is_affected(ch, gsn_rnet_trap)){
					char_puts("There's not enough room"
						" in the net!\n",ch);
					act_puts("$n wriggles angrily inside"
						" $s net.",
						ch,NULL,NULL,TO_ROOM,
						POS_RESTING);
				}
...
void substitute_alias(DESCRIPTOR_DATA *d, const char *argument)
{
    ...
    if (!ch) {
	    BUG("substitute_alias: NULL character?");
	    return;
    }
