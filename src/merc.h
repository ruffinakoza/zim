...
/*
 * $Id: merc.h 1019 2007-02-15 00:52:41Z zsuzsu $
 */
...
#define ALIGN_INDEX_NONE	0
#define ALIGN_INDEX_GOOD	1
#define ALIGN_INDEX_NEUTRAL	2
#define ALIGN_INDEX_EVIL	3
#define ALIGN_INDEX_MAX		4
...
#define RACE_ARIAL            (0)
#define RACE_CLOUD_GIANT      (1)
#define RACE_DARK_ELF         (2)
#define RACE_DUERGAR          (3)
#define RACE_DWARF            (4)
#define RACE_ELF              (5)
#define RACE_FELAR            (6)
#define RACE_FIRE_GIANT       (7)
#define RACE_FROST_GIANT      (8)
#define RACE_GITHYANKI        (9)
#define RACE_GNOME            (10)
#define RACE_HALF_ELF         (11)
#define RACE_HUMAN            (12)
#define RACE_ORC              (13)
#define RACE_ROCKSEER         (14)
#define RACE_SATYR            (15)
#define RACE_STORM_GIANT      (16)
#define RACE_SVIRFNEBLI       (17)
#define RACE_TROLL            (18)
#define RACE_HALFLING         (19)
#define RACE_WOOD_ELF         (20)
#define RACE_HALF_ORC	      (21)

/* restrict races */
#define RRACE_NONE		(0)
#define RRACE_NPC		(A)
#define RRACE_ARIAL		(B)
#define RRACE_CLOUD_GIANT	(C)
#define RRACE_DARK_ELF		(D)
#define RRACE_DUERGAR		(E)
#define RRACE_DWARF		(F)
#define RRACE_ELF		(G)
#define RRACE_FELAR		(H)
#define RRACE_FIRE_GIANT	(I)
#define RRACE_FROST_GIANT	(J)
#define RRACE_GITHYANKI		(K)
#define RRACE_GNOME		(L)
#define RRACE_HALF_ELF		(M)
#define RRACE_HUMAN		(N)
#define RRACE_ORC		(O)
#define RRACE_ROCKSEER		(P)
#define RRACE_SATYR		(Q)
#define RRACE_STORM_GIANT	(R)
#define RRACE_SVIRFNEBLI	(S)
#define RRACE_TROLL		(T)
#define RRACE_HALFLING		(U)
#define RRACE_WOOD_ELF		(V)

/* classes for class table */
/* note: this needs to match with the order of class/classes.lst */
#define CLASS_NEUTRAL		(-1)
#define CLASS_DARKKNIGHT	(0)
#define CLASS_CLERIC		(1)
#define CLASS_NECROMANCER	(2)
#define CLASS_NINJA		(3)
#define CLASS_PALADIN		(4)
#define CLASS_RANGER		(5)
#define CLASS_SAMURAI		(6)
#define CLASS_THIEF		(7)
#define CLASS_VAMPIRE		(8)
#define CLASS_WARLOCK		(9)
#define CLASS_WARRIOR		(10)
#define CLASS_WITCH		(11)
#define CLASS_ROGUE		(12)

#define RCLASS_NONE		(0)
#define RCLASS_DARKKNIGHT	(A)
#define RCLASS_CLERIC		(B)
#define RCLASS_NECROMANCER	(C)
#define RCLASS_NINJA		(D)
#define RCLASS_PALADIN		(E)
#define RCLASS_RANGER		(F)
#define RCLASS_SAMURAI		(G)
#define RCLASS_THIEF		(H)
#define RCLASS_VAMPIRE		(I)
#define RCLASS_WARLOCK		(J)
#define RCLASS_WARRIOR		(K)
#define RCLASS_WITCH		(L)
#define RCLASS_ROGUE		(M)
...
#define CON_NEWBIE_DETECTOR		20
#define CON_NEWBIE_PROTECTION		21
#define CON_TRUE_LIFER			22
#define CON_ANSI_DETECTOR		23
#define CON_CREATE_DONE 		24
#define CON_RESOLV			25
#define CON_DUMMY 			26
...
#define AREA_HIDDEN		(D)	/* not shown to morts on area list*/
#define AREA_PLAYERHOUSE	(E)	/* player house */
#define AREA_CLANHALL		(F)	/* a clan hall */
#define AREA_NOSUMMON		(G)	/* the whole area is transport */
...
#define ACT_SUMMONED            (gg)	/* summoned (mage etc.)*/
#define ACT_SUMMONED            (gg)	/* summoned (warrior etc.)*/
#define ACT_SAGE		(hh)	/* sage (Otho etc.)	*/
#define ACT_MUTE		(ii)	/* doesn't yell/speak etc */
#define ACT_AGGRO_RELATIVE	(jj)	/* only aggro in sensible range */
#define ACT_GAMBLER		(kk)	/* gambler mob */

/* attributes for mobiles */
#define MOB_ATTR_NOQUEST	(A)	/* don't offer quests to this mob */
#define MOB_ATTR_NOFIND		(B)	/* can't hunt / eyes of intrigue */
#define MOB_ATTR_PET_ARMORED	(C)	/* can equip a pet with armor */
#define MOB_ATTR_PET_WEAPONED	(D)	/* can equip a pet with weapon */
#define MOB_ATTR_BASHES_DOORS	(E)	/* can ask it to bash a door */
#define MOB_ATTR_BLACKMARKET	(F)	/* buy stolen goods/serve criminals*/
...
#define AFF_ENHANCED_ARMOR	(vv)
#define AFF_MINOR_SANCTUARY	(ww)
#define AFF_MINOR_BLACK_SHROUD	(xx)

#define AFF_NO_DISPLAY		(zz)
/* XXX - the above are only for mobs.
 * 	and are limted to "zz" currently
 */
...
#define RAFF_RANGER_TRAP        (F)
#define RAFF_MIDNIGHT		(G)
#define RAFF_CURSE		(K)
...
#define RSEX_NONE		(0)
#define RSEX_MALE		(A)
#define RSEX_FEMALE		(B)
#define RSEX_NEUTER		(C)
...
#define RSIZE_NONE		(0)
#define RSIZE_TINY		(A)
#define RSIZE_SMALL		(B)
#define RSIZE_MEDIUM		(C)
#define RSIZE_LARGE		(D)
#define RSIZE_HUGE		(E)
#define RSIZE_GIANT		(F)
#define RSIZE_GARGANTUAN 	(G)
...
#define ITEM_QUESTFIND		36
#define ITEM_PARCHMENT		37
#define ITEM_MEDAL		38
#define ITEM_AWARD		39
...
#define ITEM_PIT		(gg)
#define ITEM_RARE		(hh)	/* higher BP, lower spawn rate */
#define ITEM_UNIQUE		(ii)	/* player can possess only one */
#define ITEM_NOFIND		(jj)	/* shadow's find doesn't work */
#define ITEM_NOBAG 		(kk)	/* can't put in a container */
...
#define WEAPON_SHURIKEN         13
#define WEAPON_SHORTSWORD       14   
#define WEAPON_BASTARDSWORD     15
#define WEAPON_HAMMER		16
#define WEAPON_KATANA		17
...
#define WEAPON_KATANA_QUEST	(J)
#define WEAPON_CRUSH		(K)
#define WEAPON_TAINTED		(L)

#define ARMOR_NONE      0
#define ARMOR_CLOTH     1
#define ARMOR_LIGHT     2
#define ARMOR_MEDIUM    3
#define ARMOR_HEAVY     4
...
/* parchment flags */
#define WRITE_PERM		(A)
#define WRITE_BULLETIN		(B)

/* award types */
#define AWARD_UNKNOWN		0
#define AWARD_ROLEPLAY		1
...
#define CONT_SCROLL		(G)
#define CONT_POTION		(H)
#define CONT_PILL		(I)
#define CONT_WAND		(J)
#define CONT_STAFF		(K)
 ...
 * Sector types.
 * Used in #ROOMS.
 * Remember to change move values in act_move.c
 */
...
#define WEAR_AWARD		     23
#define WEAR_MEDAL		     24
#define MAX_WEAR		     25
...
/* ethos restrictions */
#define RE_NONE			ETHOS_NONE
#define RE_LAWFUL		ETHOS_LAWFUL
#define RE_NEUTRAL		ETHOS_NEUTRAL
#define RE_CHAOTIC		ETHOS_CHAOTIC
#define RE_ALL			(ALL)

/* RT auto flags */
#define PLR_CONF_AUTOASSIST		(A)
#define PLR_CONF_AUTOEXIT		(B)
#define PLR_CONF_AUTOLOOT		(C)
#define PLR_CONF_AUTOSAC		(D)
#define PLR_CONF_AUTOGOLD		(E)
#define PLR_CONF_AUTOSPLIT		(F)
#define PLR_CONF_AUTOLOOK		(G)
#define PLR_CONF_NOSUMMON		(H)
#define PLR_CONF_NOFOLLOW		(I)
#define PLR_CONF_NEWBIE_HELPER		(J)
#define PLR_CONF_HOLYLIGHT		(K)
#define PLR_CONF_AUTO_CLAN_SKILL	(L)	/*turn on or off a clan skill*/
#define PLR_CONF_BLINK			(M)
#define PLR_CONF_PRACTICER		(O)

#define ACCT_NPC			(A)	/* don't ever set */
#define ACCT_NEW			(B)
#define ACCT_NEWBIE			(C)
#define ACCT_MULTIKILLER		(D)
#define ACCT_TRUE_LIFER			(E)
#define ACCT_DELETING			(F)

#define STATE_GHOST		(A)
#define STATE_WANTED		(B)
#define STATE_BOUGHT_PET	(C)
#define STATE_PUMPED		(E)	/* adrenaline is gushing */
#define STATE_MANACLE		(F)
#define STATE_HARA_KIRI		(G)
#define STATE_DENY		(H)
#define STATE_FREEZE		(I)
#define STATE_NOTITLE		(J)
#define STATE_NOEXP		(K)
#define STATE_LOG 		(L)
...
#define TRUST_GOOD		(D)
#define TRUST_NEUTRAL		(E)
#define TRUST_EVIL		(F)

/* past owner of items */
#define PAST_OWNER_LAST		0
#define PAST_OWNER_MAX		4

#define IS_HARA_KIRI(ch) (IS_SET((ch)->state_flags, STATE_HARA_KIRI))
...
#define IS_PUMPED(ch) (IS_SET((ch)->state_flags, STATE_PUMPED))
#define SET_FIGHT_TIME(ch)					\
	{							\
		(ch)->last_fight_time = current_time;		\
		SET_BIT((ch)->state_flags, STATE_PUMPED);		\
	}
...
/* display flags */
#define COMM_QUIET_EDITOR	(C)
#define COMM_COMPACT		(D)
#define COMM_BRIEF		(E)
#define COMM_PROMPT		(F)
#define COMM_COMBINE		(G)
#define COMM_TELNET_GA		(H)
#define COMM_SHOWAFF		(I)

#define COMM_COLOR		(L)

#define COMM_NOENG		(M)
#define COMM_SNOOP_PROOF	(N)
#define COMM_AFK		(O)

#define COMM_LONG		(P)
#define COMM_NOTELNET		(Q)
#define COMM_NOIAC		(R)
#define COMM_NOVERBOSE		(S)
#define COMM_NOBUST		(T)
#define COMM_NOFLEE		(U)
...
#define WIZ_LEVELS		(I)
#define WIZ_SECURE		(J)
#define WIZ_SWITCHES		(K)
#define WIZ_SNOOPS		(L)
#define WIZ_RESTORE		(M)
#define WIZ_LOAD		(N)
#define WIZ_PREFIX		(O)
#define WIZ_SPAM		(P)
#define WIZ_OLC			(Q)
#define WIZ_DEBUG		(R)
#define WIZ_BUILDER_DEBUG	(S)
#define WIZ_ANNOUNCE		(T)
#define WIZ_QUESTS		(U)
#define WIZ_ECONOMY		(V)
#define WIZ_POLITICS		(W)
#define WIZ_ALTDROP		(X)
#define WIZ_PRAY_CHAN		(Y)
#define WIZ_CLAN_CHAN		(Z)

#define THEFT_STEAL		1
#define THEFT_PAWN		2
#define THEFT_SWITCH		3
#define THEFT_PLANT		4
...
/*	mlstring *              action_desc;*/
	...
	flag64_t		acct_flags;
	flag64_t		conf_flags;
	flag64_t		state_flags;
	flag64_t		fixed_flags;	/* bug fix status */
	flag64_t		comm;	/* RT added to pad the vector */
	flag64_t		channels;
	flag64_t		restricted_channels; /* for penalizing players */
	flag32_t		imm_flags;
	flag32_t		res_flags;
	flag32_t		vuln_flags;
	int			invis_level;
	...
	int			hitroll;
	int			damroll;
	int			nimroll; /* nimble roll -- for defense bonus*/
	int			armor[4];
	int			wimpy;
	/* stats */
	...
	CHAR_DATA *		doppel;
	CHAR_DATA *		target;
	ROOM_INDEX_DATA *	last_transfer;	/* vnum of origin room */
	CHAR_DATA *		cursed_by_witch;/* witch that cursed you */
	GAMBLE_DATA *		gamble;		/* sometimes null */
};


/* indexes */
#define STAT_AVG_TOTAL		0
#define STAT_AVG_NUM		1
#define MAX_STAT_AVG		2
...
struct pc_data
{
	...
	char			anon_color; 	/* so morts can tell anon imms apart*/
/*        time_t                  logon; */
	time_t			born;
	time_t			last_note;
	time_t			last_idea;
...
/*        int                     train; */
	...
	int			perm_dam;
	int			perm_nim;
	int			trend_stat[MAX_STATS];
	int			stat_avg[MAX_STATS][MAX_STAT_AVG];
	flag32_t		true_sex;
	flag32_t		trust;
	flag64_t		wiznet; /* wiz stuff */
	int 			last_level;
	...
	int 			death;
	int 			played;
	int			align_standing[ALIGN_INDEX_MAX];/* standing with your alignment*/
	int			align_killed[ALIGN_INDEX_MAX];
	...
	int			saved_stalkers;
	const char *		enslaver;
	const char *		pk_ok_list;	/*people can pk out of range*/
	const char *		fake_ip;	/*bogus ip address for sockets*/
	int 			security;	/* OLC */ /* Builder security */
};

/*
 * moral standing (relative to alignment)
 */
#define ALIGN_STANDING_B7 -7
#define ALIGN_STANDING_B6 -6
#define ALIGN_STANDING_B5 -5
#define ALIGN_STANDING_B4 -4
#define ALIGN_STANDING_B3 -3
#define ALIGN_STANDING_B2 -2
#define ALIGN_STANDING_B1 -1
#define ALIGN_STANDING_0   0
#define ALIGN_STANDING_G1  1
#define ALIGN_STANDING_G2  2
#define ALIGN_STANDING_G3  3
#define ALIGN_STANDING_G4  4
#define ALIGN_STANDING_G5  5
#define ALIGN_STANDING_G6  6
#define ALIGN_STANDING_G7  7
#define ALIGN_STANDING_G8  8
...
#define LIQ_AFFECT_PROOF	0
#define LIQ_AFFECT_FULL		1
#define LIQ_AFFECT_THIRST	2
#define LIQ_AFFECT_FOOD		3
#define LIQ_AFFECT_SSIZE	4
...
/* for value[] */
#define ITEM_VALUE_MAX				7
#define ITEM_VALUE_UNUSED_1			1
#define ITEM_VALUE_UNUSED_2			2
#define ITEM_VALUE_UNUSED_3			3
#define ITEM_VALUE_UNUSED_4			4
#define ITEM_VALUE_UNUSED_5			5
#define ITEM_VALUE_UNUSED_6			6

#define ITEM_LIGHT_DURATION			2

#define ITEM_WAND_LEVEL				0
#define ITEM_WAND_CHARGES_TOTAL			1
#define ITEM_WAND_CHARGES_REMAINING		2
#define ITEM_WAND_SPELL				3

#define ITEM_PORTAL_CHARGES			0
#define ITEM_PORTAL_EXIT_FLAGS			1
#define ITEM_PORTAL_FLAGS			2
#define ITEM_PORTAL_DEST			3
#define ITEM_PORTAL_KEY				4

#define ITEM_WEAPON_TYPE			0
#define ITEM_WEAPON_DICE_NUM			1
#define ITEM_WEAPON_DICE_SIZE			2
#define ITEM_WEAPON_ATTACK_TYPE			3
#define ITEM_WEAPON_FLAGS			4

#define ITEM_PARCHMENT_FLAGS			1

#define ITEM_FURNITURE_QUANTITY			0
#define ITEM_FURNITURE_WEIGHT			1
#define ITEM_FURNITURE_FLAGS			2
#define ITEM_FURNITURE_HEAL_RATE		3
#define ITEM_FURNITURE_MANA_RATE		4

#define ITEM_POTION_LEVEL			0
#define ITEM_POTION_SPELL1			1
#define ITEM_POTION_SPELL2			2
#define ITEM_POTION_SPELL3			3
#define ITEM_POTION_SPELL4			4

#define ITEM_ARMOR_AC_PIERCE			0
#define ITEM_ARMOR_AC_BASH			1
#define ITEM_ARMOR_AC_SLASH			2
#define ITEM_ARMOR_AC_EXOTIC			3
#define ITEM_ARMOR_TYPE				4
#define ITEM_ARMOR_FLAGS			5

#define ITEM_CONTAINER_WEIGHT			0
#define ITEM_CONTAINER_FLAGS			1
#define ITEM_CONTAINER_KEY			2
#define ITEM_CONTAINER_PER_ITEM_WEIGHT		3
#define ITEM_CONTAINER_WEIGHT_MULTI		4
#define ITEM_CONTAINER_QUANTITY			5

#define ITEM_DRINK_TOTAL			0
#define ITEM_DRINK_REMAINING			1
#define ITEM_DRINK_TYPE				2
#define ITEM_DRINK_POISON			3

#define ITEM_FOOD_HOURS				0
#define ITEM_FOOD_FULL				1
#define ITEM_FOOD_POISON			3

#define ITEM_MONEY_SILVER			0
#define ITEM_MONEY_GOLD				1

#define ITEM_AWARD_TYPE				0
#define ITEM_AWARD_VALUE			1
#define ITEM_AWARD_YEAR				2
#define ITEM_AWARD_MONTH			3
#define ITEM_AWARD_DAY				4
...
struct obj_index_data
{
	...
	int			weight;
	int 			cost;
	int 			value[ITEM_VALUE_MAX];
	int 			limit;
	OPROG_FUN **		oprogs;
	int			clan;
	flag32_t		rsex; /*restricted*/
	flag32_t		rrace;
	flag32_t		rclass;
	flag32_t		rsize;
};
...
struct obj_data
{
	...
	int 			progtypes;
	mlstring *		owner;
	mlstring *		killer;				/* corpses */
	altar_t *		altar;
	bool			extracted;
	int 			water_float;
	const char *		past_owner[PAST_OWNER_MAX];	/* alt-drop prevention*/
	const char *		past_owner_ip[PAST_OWNER_MAX];	/* alt-drop prevention*/
	int			stolen_from;			/* vnum of shop keeper*/
	OBJ_AUGMENT_DATA *	augment;	/*see consecrate.h*/
};
...
struct exit_data
{
	...
	int		lock_level;
	int		trap_level;
	bool		lock_picked;	/* only once a reset */
	bool		trap_disarmed;	/* only once a reset */
};
...
struct area_data
{
	...
	const char *	credits;
	int		age;
	int		nplayer;	/* number of players in that area*/
	int		interlopers;	/* number of invaders in a clanned area*/
	bool		empty;		/* is the area empty of players */
	int		min_level;
	int		max_level;
	int		min_vnum;
	int		max_vnum;
 ...
 * Character macros.
 */
#define IS_NPC(ch)		(IS_SET((ch)->acct_flags, ACCT_NPC))
...
#define IS_TRUSTED(ch, lev)	((IS_NPC(ch) ?				    \
					...
					(ch)->level) >= (lev))
#define IS_TRUSTED_IMP(ch)	((ch)->level == ML \
					&& !str_cmp(ch->name, TRUSTED_IMP))
...
#define GET_HITROLL(ch) (ch_hitroll(ch))
#define GET_DAMROLL(ch) (ch_damroll(ch))
#define GET_NIMROLL(ch) ((ch->nimroll > 0) ? ch->nimroll : ch->level * 7);
...
#define ch_weight_carried(ch)	((ch)->carry_weight + (ch)->silver/10 +  \
						      (ch)->gold * 2 / 5)
#define ENCUMBERANCE(ch)        (IS_IMMORTAL(ch) ? 1 : (ch_weight_carried(ch) * 100) / ch_max_carry_weight(ch))
...
#define RIDDEN(ch)	((IS_NPC(ch) && ch->mount && ch->riding) ? \
				ch->mount : NULL)
#define IS_DRUNK(ch)	is_drunk(ch)
#define IS_NEWBIE(ch)	(IS_SET(ch->acct_flags, ACCT_NEWBIE))

#define IS_DELETED(ch)	(!ch->name)
...
#define IS_WEAPON_STAT(obj,stat)(IS_SET((obj)->value[ITEM_WEAPON_FLAGS],(stat)))
#define IS_CONTAINER_TYPE(obj,stat)(IS_SET((obj)->value[ITEM_CONTAINER_FLAGS],(stat)))
#define WEIGHT_MULT(obj)	((obj)->pIndexData->item_type == ITEM_CONTAINER ? \
	(obj)->value[ITEM_CONTAINER_WEIGHT_MULTI] : 100)
#define IS_OBJ_RARE(obj)	(IS_SET((obj)->extra_flags, ITEM_RARE))
#define IS_OBJ_UNIQUE(obj)	(IS_SET((obj)->extra_flags, ITEM_UNIQUE))
#define IS_OBJ_LIMITED(obj)	((obj)->limit > 0)

/*
 * Description macros.
 */
/* new defines */
#define MAX_CHARM(ch)	(ch->level >= (LEVEL_HERO - (LEVEL_HERO / 12)) ? 2 : 1)
#define IS_AGGRO(ch,victim)	(is_aggressive_to(ch, victim))

#define CHAR_NAME(ch)		(mlstr_mval(ch->short_descr))
#define OBJ_SHORTNAME(obj)	(mlstr_mval(obj->short_descr))
...
extern	flag32_t		global_channels;
extern	bool			merc_down;    /* Shutdown                     */
extern	bool			wizlock;      /* Game is wizlocked            */
extern	bool			newlock;      /* Game is newlocked            */
extern	char			str_boot_time[26];
extern	int			iNumPlayers; /* The number of players on */

extern	int			max_on;
extern  int			Line_Number; /* When reading files */
...
int	drunk_effect	(CHAR_DATA *ch, int level, bool intoxicate);
...
bool	is_name_empty 	(const char *str);
...
bool	name_find	(const char *list, const char *name); 
...
int	apply_ac	(CHAR_DATA *, OBJ_DATA *obj, int iWear, int type);
...
/* comm/comm_colors.c */
const char *	color_name	(char);

/* interp.c */
void	do_help		(CHAR_DATA *ch, const char *argument);
void	do_say		(CHAR_DATA *ch, const char *argument);
void	interpret	(CHAR_DATA *ch, const char *argument);
int	interpret_raw	(CHAR_DATA *ch, const char *argument, bool is_order, int force_level);
...
void		help_show	(CHAR_DATA *ch, BUFFER *output,
				 const char *keyword, bool border);
...
bool	append_file	(const char *file, const char *str);
...
int	do_who_raw	(CHAR_DATA *ch, CHAR_DATA *vch, BUFFER *output);
...
void wiznet_theft(CHAR_DATA *ch, CHAR_DATA *victim,
		...
		int sn, int chance, bool success, int worth);
...
int	autoweapon (OBJ_DATA *obj, int percent_damage); /*handler.c*/
